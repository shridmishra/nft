...
export default function Hero() {
  return (
    <div className="px-2 lg:px-[146px] pt-12 lg:pt-44 pb-10 bg-hero">
      <section className="relative flex items-center justify-center bg-hero min-h-screen w-full overflow-hidden px-8">
        ...
        {/* === DUAL TEXT LABELS === */}
        {/* Top-left */}
        <div className="absolute top-4 left-4 space-y-1 flex flex-col">
          <DualColorText firstText="DSP:" secondText="1707 x 979" />
          <DualColorText firstText="FPS:" secondText="67.90" />
        </div>

        {/* Top-right */}
        <div className="absolute top-4 right-4 space-y-1 text-right  flex-col hidden lg:flex">
        ...
        {/* Bottom-left */}
        <div className="absolute bottom-4 left-4 space-y-1 hidden lg:flex flex-col">
          <DualColorText firstText="EVO:" secondText=" Alpha" />
          <DualColorText firstText="VERS:" secondText=" 01.08.84" />
        </div>

        {/* Bottom-right */}
        <div className="absolute bottom-4 right-4 space-y-1 text-right flex flex-col">
        ...
        {/* Mid-right */}
        <div className="absolute right-4 top-1/2 -translate-y-1/2 text-right hidden lg:block">
          <DualColorText firstText="0.49 " secondText="\\\\" whiteFirst={false} />
        </div>

        {/* === CENTER CONTENT === */}
        <div className="max-w-4xl text-center">
          <h1 className=" text-6xl lg:text-[84px] leading-[80px] font-atomos outline-text font-medium capitalize mb-6">
